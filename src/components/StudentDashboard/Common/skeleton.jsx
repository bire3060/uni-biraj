...
const Skeleton = ({ add }) => {
  return (
    <div className=" grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1  items-center gap-14 rounded-xl w-full">
      {[1, 2, 3, 4, 5, 6].map((data, index) => {
        return (
          <div
            key={index}
            className="box-shadow animate-pulse bg-white rounded-lg p-3 py-4 text-gray7 space-y-2 text-sm"
          >
            <div className="font-bold bg-gray-300 text-gray-300 text-base">
              name here
            </div>
            <div className="pt-4 mt-6">
              {/* <img src={image} alt={image} className="h-7 overflow-hidden" /> */}
              <div className="h-16 w-32 bg-gray-300 text-gray-300 overflow-hidden" />
            </div>
            <div className="font-semibold bg-gray-300 text-gray-300">
              institution
            </div>
            <div>
              <div className="flex space-x-2 items-center">
                ...
                <div className="bg-gray-300 text-gray-300">address</div>
              </div>
              <div className="flex space-x-2 items-center">
                <div className="text-gray6 py-2">
                ...
                <div className="bg-gray-300 text-gray-300"> months</div>
              </div>
              <div className="flex space-x-2 items-center">
                <div className="text-gray6 py-2">
                  <svg
              ...
              c3.98,1.405,5.579,3.245,5.579,6.254C30.33,30.003,28.227,32.547,24.37,33.215z"
                ...
                <div className="bg-gray-300 text-gray-300">
                  {/* {domestic_fee}/{international_fee} */}6 (Monthly)
                </div>
              </div>
              <div className="flex space-x-2 items-center">
                <div className="text-gray6 py-2">
                ...
                <div className="bg-gray-300 text-gray-300">{"On Campus"}</div>
              </div>
            </div>
            {/* <div
            ...
            ></div> */}
            <div className="text-xs  bg-gray-300 text-gray-300 line-clamp-3">
              description
            </div>
            {add && (
              <div className="flex text-center items-center space-x-2">
                <div className="flex-1 pt-5 pb-3">
                  <button className="w-full py-2 bg-gray-300 text-gray-300 rounded-full  font-bold">
                    {"Apply"}
                  </button>
                </div>
