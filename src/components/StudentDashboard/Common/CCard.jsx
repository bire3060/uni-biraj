...
import dummyImage from "../../../assets/images/courses/Course-card-logo1.png";
const CourseCard = ({ persons, type }) => {
  const {
    title,
    // image,z
    institution,
  ...
  return (
    <div className="box-shadow bg-white rounded-lg p-3 py-4 text-gray7 space-y-2 text-sm">
      <div className="font-bold text-base">{type === "add" ? name : title}</div>
      <div className="pt-4 mt-6">
        {/* <img src={image} alt={image} className="h-7 overflow-hidden" /> */}
        <img src={dummyImage} className="h-16 w-32 overflow-hidden" alt="" />
      </div>
      ...
      <div className="flex text-center items-center space-x-2">
        <div className="flex-1 pt-5 pb-3">
          <button className="w-full py-2 bg-pink1 rounded-full text-pink4 font-bold">
            {type === "add" ? "ADD" : "Apply"}
          </button>
        </div>
